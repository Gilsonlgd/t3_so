...
OBJS = exec.o cpu_estado.o es.o mem.o rel.o term.o instr.o err.o processo.o mmu_fifo.o\
			 tela.o contr.o so.o mmu.o tab_pag.o teste.o rand.o escalonador_proc_rapido.o
OBJS_MONT = instr.o err.o montador.o
MAQS = ex1.maq ex2.maq ex3.maq ex4.maq ex5.maq init.maq p1.maq p2.maq p3.maq a1.maq \
